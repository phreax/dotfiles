...
syn region  jstTemplate start=+<script [^>]*type*=[^>]*text/template[^>]*>+ keepend end=+</script>+me=s-1 contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlEvent,htmlCssDefinition,@htmlPreproc,@htmlArgCluster,htmlSpecialTagName,htmlEndTag,htmlSpecialChar,htmlComment,htmlCommentPart,htmlH1,htmlH2,htmlH3,htmlH4,htmlH5,htmlH6,htmlHead,htmlTitle,htmlBoldItalicUnderline,htmlUnderlineBold,htmlUnderlineItalicBold,htmlUnderlineBoldItalic,htmlItalicUnderline,htmlItalicBold,htmlItalicBoldUnderline,htmlItalicUnderlineBold,htmlBold,htmlBoldUnderlineItalic,htmlBoldUnderline,htmlLink
 
syn match templateTag "[<>%=]" contained 
syn region jstBlock containedin=jstTemplate,htmlString,htmlH1,htmlH2,htmlH2,htmlH4,htmlLink matchgroup=templateTag start="<%" keepend end="%>" matchgroup=templateTag contains=@htmlJavaScript,htmlCssStyleComment,htmlScriptTag,@htmlPreproc
syn region jstBlock containedin=jstTemplate,htmlString,htmlH1,htmlH2,htmlH2,htmlH4,htmlLink matchgroup=templateTag start="<%=" keepend end="%>" matchgroup=templateTag contains=@htmlJavaScript,htmlCssStyleComment,htmlScriptTag,@htmlPreproc
...
if version >= 508 || !exists("did_html_syn_inits")
  ...
  HtmlHiLink templateTag             Special
