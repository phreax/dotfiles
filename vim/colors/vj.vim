...
hi Search	ctermfg=NONE ctermbg=darkyellow cterm=NONE
...
hi tabline      ctermfg=NONE ctermbg=blue
hi tablinefill  ctermfg=green ctermbg=darkblue
"vim: sw=4
"
hi MatchParen	ctermfg=NONE ctermbg=green
...
" color terminal definitions
hi Normal ctermfg=NONE ctermbg=white
...
hi WarningMsg	ctermfg=1
hi WildMenu	ctermfg=0 ctermbg=3
hi Folded	ctermfg=NONE ctermbg=white cterm=NONE
...
hi Underlined	ctermfg=NONE ctermbg=white
hi Ignore	cterm=bold ctermfg=7
hi Ignore	ctermfg=darkgrey
hi Error	cterm=bold ctermfg=7 ctermbg=1
